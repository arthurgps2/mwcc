...
Murder with Custom Characters is a modification of the original gamemode by MechanicalMind that allows you to set a list of characters for players to play as - including workshop.

**Press F3 to bring up the character edit panel** (or type *mwcc_char_panel* in the console) and start editing. You can also save/load your configs from files, hooray! __Tip__: if a file has the same name as one of your maps, that file will automatically be loaded when you start a game on that map!

If *Enhanced Playermodel Selector* is breaking this gamemode's custom models, make sure to **__blacklist the gamemode__** on its settings menu.
